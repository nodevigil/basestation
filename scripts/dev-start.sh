...
echo "  docker-compose run --rm app python main.py --help"
echo "  docker-compose run --rm app python main.py recon sui"
echo "  docker-compose run --rm app python main.py scan <ip>"
